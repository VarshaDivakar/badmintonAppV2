    ...
    return (
        <View style={style.container}>
            <View style={{
                ...
                <Pressable style={{...style.checkoutBtn,marginRight:5}} onPress={()=> navigation.navigate(navigations.selectPayment)}>
                <Text style={style.confirmBooking}>Checkout</Text>
                </Pressable>

                <Pressable style={style.checkoutBtn} onPress={()=>alert('on Delete Press')}>
                <Text style={style.confirmBooking}>Delete</Text>
                </Pressable>
                </View>
