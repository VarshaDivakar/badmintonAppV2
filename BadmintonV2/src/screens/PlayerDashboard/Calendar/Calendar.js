...
import { UpcomingMatched, liveResult } from "../../../dummyData";
...
const Calendar=()=> {
    ...
    return (
        <SafeAreaWraper barStyle={'light-content'}>
            ...
            {/* <View> */}
                <Text style={style.liveResult}>Live Results</Text>
                <FlatList data={liveResult} showsVerticalScrollIndicator={false}
