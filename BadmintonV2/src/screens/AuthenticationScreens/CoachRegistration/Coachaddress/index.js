        ...
        <Keyboardavoidwraper>
          <View>
            ...
            <Text
              ...
              onPress={() => navigation.navigate(Navigations.coachpersonaldetails)}>
              + Personal Details
            </Text>
            <Rectanglebutton
              label={'Continue'}
              onPress={() =>
                navigation.navigate(Navigations.playermobileotp,{navigateToNext:Navigations.coachprofessionalexperience})
              }
            />
          </View>
        </Keyboardavoidwraper>
