...
export default function CoachUploadResults() {
        ...
        return (
            <View style={{ flexDirection: 'row', marginLeft: 'auto', right: 10 }}>
                ...
                <Rectanglebutton
                    ...
                    // }
                    onPress={() => navigation.navigate(navigations.coachuploadnewresults)}
    ...
    const renderItem = ({ item }) => (
        <View style={[styles.tableRow,{height:45}]}>
            ...
            <Text style={[styles.tableHeader,{color:'#01031C'}]}>{item.name}</Text>
        </View>
        ...
        return (
            <View style={styles.container}>
                <View style={styles.tableRow}>
                    ...
                    <Text style={styles.tableheading}>Player name</Text>
                </View>
